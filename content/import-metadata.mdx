...
- Fields should be separated by one valid delimiter: comma ( , ), semicolon ( ; ), pipe ( | ), space or tab ( ).
- If the file contains commentaries or textual information, lines can be skipped.
...
3. Click on the "Choose your File" button and select your metadata file.
...
- Specify a custom delimiter character (other than comma).
- Skip a specific number of rows at the beginning of the file.
...
To resolve import errors, review your file and ensure that it adheres to the required format. Make any necessary corrections and attempt the import again.
