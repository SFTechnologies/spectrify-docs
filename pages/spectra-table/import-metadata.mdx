...
<br/>
<Image src={`${imagePath}import_metadata1.png`} alt="import metadata 1" width={500} height={65} style={{ display: 'block', margin: '0 auto' }} />

3. Click on the "Choose your File" button and select your metadata CSV file.
4. Review the Preview. 
<br/>
<Image src={`${imagePath}import_metadata2.png`} alt="import metadata 2" width={800} height={65} style={{ display: 'block', margin: '0 auto' }} />
...
<br/>
<Image src={`${imagePath}import_metadata3.png`} alt="import metadata 3" width={500} height={65} style={{ display: 'block', margin: '0 auto' }} />
...
<br/>
<Image src={`${imagePath}import_metadata4.png`} alt="import metadata 4" width={800} height={65} style={{ display: 'block', margin: '0 auto' }} />
