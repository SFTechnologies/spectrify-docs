...
<p className='formula'>$x^{centered} = x - \mu$</p>
...
<p className='formula'>$x^{snv} = \frac{x - \mu}{\sigma}$</p>
...
<p className='formula'>$x^{robust} = \frac{x - \tilde{x}}{IQR}$</p>
...
<p className='formula'>$y = x - (ax + b)$</p>
