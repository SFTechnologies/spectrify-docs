...
<Image src={`${imagePath}collapsed_table.png`} alt="collapsed spectra table" width={400} height={100} style={{ display: 'block', margin: '0 auto' }} />
...
<br/>
<Image src={`${imagePath}extended_table.png`} alt="extended spectra table" width={800} height={100} style={{ display: 'block', margin: '0 auto' }} />
